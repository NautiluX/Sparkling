...
function sparkling_footer_info() {
	...
	printf( esc_html__( 'Theme by %1$s Powered customized by %2$s', 'sparkling' ) , '<a href="http://colorlib.com/" target="_blank">Colorlib</a>', '<a href="https://manueldewald.de/" target="_blank">Manuel Dewald</a>' );
}
